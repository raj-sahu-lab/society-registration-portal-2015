...
<ContentTemplate>
    <table align="center">
        ...
        <td>
        <asp:DropDownList ID="ddl_prant" runat="server" Width="160px" AutoPostBack="false">
        </asp:DropDownList>
        </td>
        </tr>
        <tr>
              ...
              <td>
                  <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="Kshetra_Name" HeaderText="Kshetra_Name" 
                              SortExpression="Kshetra_Name" />
                      </Columns>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                      ...
                      InsertCommand="INSERT INTO [KshetraMaster] ([Sr_No], [Country], [Zone], [State], [Kshetra_Name]) VALUES (@Sr_No, @Country, @Zone, @State, @Kshetra_Name)" 
                      SelectCommand="SELECT * FROM [KshetraMaster] ORDER BY [Sr_No], [Country], [Zone]" 
                      UpdateCommand="UPDATE [KshetraMaster] SET [Country] = @Country, [Zone] = @Zone, [State] = @State, [Kshetra_Name] = @Kshetra_Name WHERE [Sr_No] = @Sr_No">
                      <DeleteParameters>
