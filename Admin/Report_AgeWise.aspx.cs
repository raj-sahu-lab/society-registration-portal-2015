...
public partial class Admin_Report_AgeWise : System.Web.UI.Page
{
    ...
    void Upliner_Details()
    {
        ...
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Age>=@ageFrom AND Age<=@ageTo Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@ageFrom", txtfrom_date.Text),
            new SqlParameter("@ageTo", txtto_date.Text));
    ...
    void GV_Details_CountryWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Age>=@ageFrom AND Age<=@ageTo AND Country=@country Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@ageFrom", txtfrom_date.Text),
            new SqlParameter("@ageTo", txtto_date.Text),
    ...
    void GV_Details_StateWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Age>=@ageFrom AND Age<=@ageTo AND Country=@country AND State=@state Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@ageFrom", txtfrom_date.Text),
            new SqlParameter("@ageTo", txtto_date.Text),
            new SqlParameter("@country", ddl_country.Text),
    ...
    void GV_Details_DistrictWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Age>=@ageFrom AND Age<=@ageTo AND Country=@country AND State=@state AND District=@district Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@ageFrom", txtfrom_date.Text),
            new SqlParameter("@ageTo", txtto_date.Text),
            new SqlParameter("@country", ddl_country.Text),
    ...
    void GV_Details_CityWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Age>=@ageFrom AND Age<=@ageTo AND Country=@country AND State=@state AND District=@district AND Vidhansabha=@city Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@ageFrom", txtfrom_date.Text),
            new SqlParameter("@ageTo", txtto_date.Text),
            new SqlParameter("@country", ddl_country.Text),
    ...
    void GV_Details_VillageWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Age>=@ageFrom AND Age<=@ageTo AND Country=@country AND State=@state AND District=@district AND Vidhansabha=@city AND Village=@village Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@ageFrom", txtfrom_date.Text),
            new SqlParameter("@ageTo", txtto_date.Text),
            new SqlParameter("@country", ddl_country.Text),
    ...
    void GV_Details_NameWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Age>=@ageFrom AND Age<=@ageTo AND Country=@country AND State=@state AND District=@district AND Vidhansabha=@city AND Village=@village AND Name=@name Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@ageFrom", txtfrom_date.Text),
            new SqlParameter("@ageTo", txtto_date.Text),
            new SqlParameter("@country", ddl_country.Text),
