...
<table>
 <tr>
            <td><asp:Label ID="Label2" runat="server" Text="Select Reg ID"></asp:Label></td>
            <td><asp:DropDownList ID="ddl_regid" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddl_regid_SelectedIndexChanged"></asp:DropDownList></td>            
            <td><asp:Label ID="Label6" runat="server" Text="Select Name"></asp:Label></td>
            <td><asp:DropDownList ID="ddl_name" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddl_name_SelectedIndexChanged"></asp:DropDownList></td>
            </tr>
			</table>
