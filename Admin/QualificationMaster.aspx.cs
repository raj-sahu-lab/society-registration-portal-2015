...
public partial class Admin_QualificationMaster : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            con.ConnectionString = ConfigurationManager.ConnectionStrings["BITRSS"].ConnectionString.Trim();
            con.Open();
            cmd.CommandText = "Insert into QualificationMaster(Sr_No, Qualification_Name) values(@srNo, @qualificationName)";
            cmd.Parameters.AddWithValue("@srNo", txtcomm_id.Text);
            cmd.Parameters.AddWithValue("@qualificationName", txtlabel_name.Text);
            cmd.Connection = con;
            cmd.ExecuteNonQuery();
