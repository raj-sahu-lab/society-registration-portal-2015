<%@ Page Language="C#" MasterPageFile="~/Admin/ReportMasterPage.master" AutoEventWireup="true" CodeFile="Report_OccupationWise.aspx.cs" Inherits="Admin_Report_OccupationWise" Title="Reporting" %>
...
<ContentTemplate>
    <table align="center" width="600px">
        <tr>
            <td colspan="2" align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Occupation wise Member Report"></asp:Label>
            </td>
        </tr>
        <tr>
        <td colspan="2" align="center">
        ...
        <table>
			...
			<tr>
            <td><asp:Label ID="lb_Qualification" runat="server" Text="Occupation"></asp:Label></td>
            <td><asp:DropDownList ID="ddl_qualification" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddl_qualification_SelectedIndexChanged"></asp:DropDownList></td>
             <td><asp:Label ID="lb_specialization" runat="server" Text="Specialization"></asp:Label></td>
            <td><asp:DropDownList ID="ddl_specialization" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddl_specialization_SelectedIndexChanged"></asp:DropDownList></td>                         
            </tr> 
			<tr>
            <td><asp:Label ID="lb_subspecialization" runat="server" Text="Sub Specialization"></asp:Label></td>
            <td><asp:DropDownList ID="ddl_subspecialization" runat="server" Width="200px" AutoPostBack="True" OnSelectedIndexChanged="ddl_subspecialization_SelectedIndexChanged"></asp:DropDownList></td>       
            <td><asp:Label ID="lb_subsubspecialization" runat="server" Text="Sub Sub Specialization"></asp:Label></td>
            <td><asp:DropDownList ID="ddl_subsubspecialization" runat="server" Width="200px" AutoPostBack="true" OnSelectedIndexChanged="ddl_subsubspecialization_SelectedIndexChanged"></asp:DropDownList></td>                            
            </tr>           
            <tr>
