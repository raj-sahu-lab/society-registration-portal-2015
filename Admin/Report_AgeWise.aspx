<%@ Page Language="C#" MasterPageFile="~/Admin/ReportMasterPage.master" AutoEventWireup="true" CodeFile="Report_AgeWise.aspx.cs" Inherits="Admin_Report_AgeWise" Title="Reporting" %>
...
<ContentTemplate>
    <table align="center" width="600px">
        <tr>
            <td colspan="2" align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Age Wise Member Report"></asp:Label>
            </td>
        </tr>
        <tr>
        <td colspan="2" align="center">
        ...
        <tr>
            ...
            <table width="100%">           
            <tr>
            <td><asp:Label ID="Label3" runat="server" Text="From Age"></asp:Label></td>
            <td>
        <table>
            <tr>
            <td> <asp:TextBox ID="txtfrom_date" runat="server" Width="175px" MaxLength="2"></asp:TextBox></td>
            <td> 
            ...
            <td><asp:Label ID="Label4" runat="server" Text="To Age"></asp:Label></td>
            <td>
        <table>
            <tr>
            <td> <asp:TextBox ID="txtto_date" runat="server" Width="175px" MaxLength="2"></asp:TextBox></td>
