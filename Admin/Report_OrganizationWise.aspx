<%@ Page Language="C#" MasterPageFile="~/Admin/ReportMasterPage.master" AutoEventWireup="true" CodeFile="Report_OrganizationWise.aspx.cs" Inherits="Admin_Report_OrganizationWise" Title="Reporting" %>
...
<ContentTemplate>
    <table align="center" width="600px">
        <tr>
            <td colspan="2" align="center">
                <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="20px" 
                    Font-Underline="True" ForeColor="#003399" Text="Organization wise Member Report"></asp:Label>
            </td>
        </tr>
        <tr>
        <td colspan="2" align="center">
        ...
        <table>
			...
			<tr>
            <td><asp:Label ID="lb_Qualification" runat="server" Text="Organization"></asp:Label></td>
