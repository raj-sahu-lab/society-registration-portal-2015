...
public partial class Admin_Report_OccupationWise : System.Web.UI.Page
{
    ...
    void GV_Details_CountryWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND Country=@country Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
    ...
    void GV_Details_StateWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND QSpecialization=@qspec AND QSpecialization1=@qspec1 AND QSpecialization2=@qspec2 AND Country=@country AND State=@state Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
    ...
    void GV_Details_DistrictWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND QSpecialization=@qspec AND QSpecialization1=@qspec1 AND QSpecialization2=@qspec2 AND Country=@country AND State=@state AND District=@district Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
            new SqlParameter("@qspec", ddl_specialization.Text),
            new SqlParameter("@qspec1", ddl_subspecialization.Text),
    ...
    void GV_Details_CityWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND QSpecialization=@qspec AND QSpecialization1=@qspec1 AND QSpecialization2=@qspec2 AND Country=@country AND State=@state AND District=@district AND Vidhansabha=@city Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
            new SqlParameter("@qspec", ddl_specialization.Text),
            new SqlParameter("@qspec1", ddl_subspecialization.Text),
    ...
    void GV_Details_VillageWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND QSpecialization=@qspec AND QSpecialization1=@qspec1 AND QSpecialization2=@qspec2 AND Country=@country AND State=@state AND District=@district AND Vidhansabha=@city AND Village=@village Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
            new SqlParameter("@qspec", ddl_specialization.Text),
            new SqlParameter("@qspec1", ddl_subspecialization.Text),
    ...
    void GV_Details_NameWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND QSpecialization=@qspec AND QSpecialization1=@qspec1 AND QSpecialization2=@qspec2 AND Country=@country AND State=@state AND District=@district AND Vidhansabha=@city AND Village=@village AND Name=@name Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
            new SqlParameter("@qspec", ddl_specialization.Text),
            new SqlParameter("@qspec1", ddl_subspecialization.Text),
    ...
    void GV_Details_QualificationWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text));
        if (dtcourse.Rows.Count > 0)
        {
    ...
    void GV_Details_SpecializationWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND QSpecialization=@qspec Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
            new SqlParameter("@qspec", ddl_specialization.Text));
        if (dtcourse.Rows.Count > 0)
    ...
    void GV_Details_SubSpecializationWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND QSpecialization=@qspec AND QSpecialization1=@qspec1 Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
            new SqlParameter("@qspec", ddl_specialization.Text),
            new SqlParameter("@qspec1", ddl_subspecialization.Text));
    ...
    void GV_Details_SubSubSpecializationWise()
    {
        GV_personal_details.DataSource = null;
        GV_personal_details.DataBind();
        string qry = "select " + RPT_COLS + " From RSS_Registration Where Occupation=@occupation AND QSpecialization=@qspec AND QSpecialization1=@qspec1 AND QSpecialization2=@qspec2 Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@occupation", ddl_qualification.Text),
            new SqlParameter("@qspec", ddl_specialization.Text),
            new SqlParameter("@qspec1", ddl_subspecialization.Text),
