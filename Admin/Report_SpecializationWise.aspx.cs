...
public partial class Admin_Report_SpecializationWise : System.Web.UI.Page
{
    ...
    void Upliner_Details()
    {
        ...
        string qry = "select " + SPEC_COLS + " From RSS_Registration Order By Reg_ID";
        DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            ...
            new SqlParameter("@qspec", ddl_zone.Text));
    ...
    void GV_Details_CountryWise()
    {
        if (ddl_option.Text == "Personal Details")
        {
            ...
            GV_personal_details.DataSource = null;
            GV_personal_details.DataBind();
            string qry = "select " + SPEC_COLS + " From RSS_Registration Where Country=@country AND QSpecialization=@qspec Order By Reg_ID";
            DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@country", ddl_country.Text),
            new SqlParameter("@state", ddl_state.Text),
            new SqlParameter("@qspec", ddl_zone.Text));
    ...
    void GV_Details_StateWise()
    {
        if (ddl_option.Text == "Personal Details")
        {
            ...
            GV_personal_details.DataSource = null;
            GV_personal_details.DataBind();
            string qry = "select " + SPEC_COLS + " From RSS_Registration Where Country=@country AND State=@state AND QSpecialization=@qspec Order By Reg_ID";
            DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@country", ddl_country.Text),
            new SqlParameter("@state", ddl_state.Text),
            new SqlParameter("@qspec", ddl_zone.Text));
    ...
    void GV_Details_DistrictWise()
    {
        if (ddl_option.Text == "Personal Details")
        {
            ...
            GV_personal_details.DataSource = null;
            GV_personal_details.DataBind();
            string qry = "select " + SPEC_COLS + " From RSS_Registration Where Country=@country AND State=@state AND District=@district AND QSpecialization=@qspec Order By Reg_ID";
            DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@country", ddl_country.Text),
            new SqlParameter("@state", ddl_state.Text),
            new SqlParameter("@qspec", ddl_zone.Text));
    ...
    {       
        if (ddl_option.Text == "Personal Details")
        {
            ...
            GV_personal_details.DataSource = null;
            GV_personal_details.DataBind();
            string qry = "select " + SPEC_COLS + " From RSS_Registration Where Country=@country AND State=@state AND District=@district AND City=@city AND QSpecialization=@qspec Order By Reg_ID";
            DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@country", ddl_country.Text),
            new SqlParameter("@state", ddl_state.Text),
            new SqlParameter("@qspec", ddl_zone.Text));
    ...
    void GV_Details_ZoneWise()
    {
        if (ddl_option.Text == "Personal Details")
        {
            ...
            GV_personal_details.DataSource = null;
            GV_personal_details.DataBind();
            string qry = "select " + SPEC_COLS + " From RSS_Registration Where QSpecialization=@qspec Order By Reg_ID";
            DataTable dtcourse = ExecuteDataTable(classDB.qryStr, CommandType.Text, qry,
            new SqlParameter("@country", ddl_country.Text),
            new SqlParameter("@state", ddl_state.Text),
            new SqlParameter("@qspec", ddl_zone.Text));
    ...
    protected void ddl_district_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            con.Open();
            cmd.Parameters.Clear();
            cmd.CommandText = "Select Distinct City from CityMaster Where Country='India' AND State_Name=@stateName AND District=@district Order By City";
            cmd.Parameters.AddWithValue("@stateName", ddl_state.Text);
