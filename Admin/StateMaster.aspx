...
<ContentTemplate>
    <table align="center">
        ...
        <td>
        <asp:DropDownList ID="ddl_zone" runat="server" Width="160px" AutoPostBack="false">
        </asp:DropDownList>
        </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="Label2" runat="server" Text="Prant Name"></asp:Label>
            </td>
            <td>
            ...
            <td colspan="2">
              ...
              <td>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                      ...
                      SelectCommand="SELECT * FROM [StateMaster] ORDER BY [Sr_No], [Country], [Zone]" 
                      UpdateCommand="UPDATE [StateMaster] SET [Country] = @Country, [Zone] = @Zone, [State_Name] = @State_Name, [State_Code] = @State_Code WHERE [Sr_No] = @Sr_No">
                      <DeleteParameters>
