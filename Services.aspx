...
<asp:Panel ID="Panel1" runat="server" Height="465px" ScrollBars="Both" Width="1020px">  
    <asp:DataList ID="DataList1" runat="server" BackColor="White" 
        DataKeyField="Service_ID" DataSourceID="SqlDataSource1" Font-Bold="False" 
        Font-Italic="False" Font-Overline="False" Font-Strikeout="False" 
        Font-Underline="False" ForeColor="Black" Width="100%">
        <FooterStyle BackColor="Blue" Font-Bold="False" Font-Italic="False" 
        ...
        <ItemStyle BackColor="#757575" Font-Bold="False" Font-Italic="False" 
            Font-Overline="False" Font-Size="Large" Font-Strikeout="False" 
        ...
        <ItemTemplate>
            ...
            <br />
            Service_Head:
            <asp:Label ID="Service_HeadLabel" runat="server" 
                Text='<%# Eval("Service_Head") %>' />
            <br />
            Service_Name:
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [ServiceMaster] ORDER BY [Service_ID], [Service_Head], [Service_Name]">
    </asp:SqlDataSource>
</asp:Panel>
</div>
                </td>
