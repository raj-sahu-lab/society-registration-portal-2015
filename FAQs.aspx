        ...
        <tr>
          ...
          <marquee Direction="Left" onmouseout="this.setAttribute('scrollamount', 3, 0);"  onmouseover="this.setAttribute('scrollamount', 0, 0);" scrolldelay="3" scrollamount="1"> <a href="">Increase your income & sales</a></marquee></div>
                      ...
                      <div style=" padding: 5px 0px; vertical-align:top; color:#f4af3b; border:solid 0px #999;background:#fff; width:880px;  height:25px;   box-shadow:1px 1px 1px 3px silver;  margin-bottom:5px; border-radius:4px; font-size:16px; background-color:Black; ">
                                ...
                                <a  style="font-size: 14px; font-weight:bold;" href="FAQs.aspx" title="On our Services">Download </a>&nbsp;|&nbsp;
...
<table cellpadding="0" cellspacing="0" align="center" class="content">
           <tr>
               ...
               <div style="width: 1020px; height: 465px" align="center">
<asp:Panel ID="Panel1" runat="server" Height="465px" ScrollBars="Both" Width="1020px">
  <%--  <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="900px" 
        AllowPaging="True" AutoGenerateRows="False" BackColor="White"
        BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
        DataKeyNames="Que_ID" DataSourceID="SqlDataSource1" GridLines="Vertical">
        <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
        <RowStyle BackColor="#EEEEEE" ForeColor="Black" />
        <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
        <Fields>
            <asp:BoundField DataField="Que_ID" HeaderText="Que_ID" ReadOnly="True" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [FAQMaster] ORDER BY [Que_ID], [Question], [Answer]">
    </asp:SqlDataSource>--%>
    <asp:DataList ID="DataList1" runat="server" BackColor="#3366FF" 
        BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
        DataKeyField="Que_ID" DataSourceID="SqlDataSource1" ForeColor="Black" 
        GridLines="Vertical" Width="100%" Font-Bold="False" Font-Italic="False" 
        Font-Overline="False" Font-Size="Large" Font-Strikeout="False" 
        Font-Underline="False">
        <FooterStyle BackColor="#3366FF" Font-Size="Large" Font-Bold="False" 
        ...
        <AlternatingItemStyle BackColor="White" Font-Bold="False" Font-Italic="False" 
            Font-Overline="False" Font-Size="Large" Font-Strikeout="False" 
            Font-Underline="False" ForeColor="Blue" />
        <ItemStyle BackColor="#FF48A4" Font-Bold="False" Font-Italic="False" 
            Font-Overline="False" Font-Size="Large" Font-Strikeout="False" 
            Font-Underline="False" ForeColor="White" />
        <SelectedItemStyle BackColor="#CE5D5A" Font-Bold="True" ForeColor="White" 
            Font-Italic="False" Font-Overline="False" Font-Size="Large" 
            Font-Strikeout="False" Font-Underline="False" />
        <HeaderStyle BackColor="#6B696B" Font-Bold="True" ForeColor="Blue" 
            Font-Italic="False" Font-Overline="False" Font-Size="Large" 
            Font-Strikeout="False" Font-Underline="False" />
        <ItemTemplate>
            Que_ID:
            <asp:Label ID="Que_IDLabel" runat="server" Text='<%# Eval("Que_ID") %>' />
            <br />
            Question:
    ...
    <div style="box-shadow:1px 1px 1px 3px silver; height:35px;  margin-bottom:-60px; background-color:Black;">

      <div style="color:color:#999;padding-top:5px;  text-align:center;"><a>COPYRIGHT © 2014. ALL RIGHTS RESERVED. | DESIGNED & DEVELOPED BY : [Company Name]</a></div>
